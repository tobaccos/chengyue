		...
		<div class="content">
			<div class="wraper bg_white">
					...
					<div class="info bg_white margin_top">
						<div class="common ">
							<span>收货人:</span>
							{{--<input type="tel" name="name" id="user" pattern=/^[\u4e00-\u9fa5]{1,}$/ required />--}}
						...
						<div class="common3">
							...
							<textarea placeholder="请输入详细地址" name="" rows="" cols="" type="text" name="detail" id="detail" required></textarea>
						</div>
					</div>
				<div class="ok">
						完成
...
var url="{{ url('/home/member/addressAdd') }}";
	...
	<script src="{{asset('js/member/addressAdd.js')}}"></script>
</html>