...
<div class="headPart" id="top">
    <a href="{{url('home/index')}}" class="return"><img src="{{asset('images/base/return.png')}}"></a>
    <input onkeyup="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5\ ]/g,'')" onpaste="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5\ ]/g,'')" oncontextmenu = "value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5\ ]/g,'')"  class="search" type="text" />
...
<div class="orderBy">
	...
	<ul class="orderItem">
		...
		<li class="sortCheck">筛选</li>
	</ul>
		<div class="orderSelected">
	...
	<ul class="proItem">
		@if($para['count'] > 0)
			...
			<li class="proItemList">
				<a class="proImg" href="{{url('home/product/proDetail')}}/{{$value->id}}/1">
...
<script>
	var type_id = [];
	 ...
	 console.log(type_id);
	var urlAll = "{{url('home/product/sort/')}}";
	var cateid = "{{$id}}";
