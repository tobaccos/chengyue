...
@section('content')
		<button class="btn  btn-xs btn-danger mybtn"  id="del">
			...
			<div class="col-xs-8 col-sm-11 data hidden-480" >
				<form class="form-search" action="{{ url('admin/order/orderMade/') }}/1" method="get">
			...
			<div class="row">
                ...
                <td>
									<div class="hidden-sm hidden-xs ">
										...
										@if($v -> filename)
										<a href="{{ url('admin/ordertestResponseDownload') }}/{{ $v-> id }}" ><button class="btn btn-xs btn-warning" >
											下载文件
										</button>
										</a>
										@endif
										...
										<button class="btn btn-xs " onclick="return succid({{ $v -> id }}) " >
											制作完成
										</button>
