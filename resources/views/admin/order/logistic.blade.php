    ...
    <div>
      <table id="tabb" border="1" cellspacing="0" cellpadding="0" >
        <thead>
          ...
          <tr>
          <td colspan="5" class="lee tdn tdn1 fz">
      ...
      <tr>
        ...
        @foreach($data as $v) 
          ...
          <tr  style="border:none; ">
            <td colspan="4" class="lee tdn fz"><label class="fz">商品合计：{{ $dingdan -> pay_amount }}</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <td  rowspan="2" class="tdn tdn1 fz">  <img src="{{url('admin/images/ma.jpg')}}"  class="logoImg" style="float:right;"/></td>
          </tr>
          <tr>
            <td colspan="6" class="lee tdn fz">  <label class="fz">备注：</label></td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="id" value="{{ $dingdan -> id }}">    </div>
