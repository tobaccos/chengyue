...
<div class="col-xs-8 col-sm-11 data hidden-480" >
	<form class="form-search" action="{{ url('admin/order/orderDeliver') }}/2" method="get">
								...
								<tr>
									...
									<td>
										<div class="hidden-sm hidden-xs ">
											<a href="{{ url('admin/order/orderDetail') }}/{{ $v-> id }}">
												<input type="button" id="man_del" class="btn btn-xs btn-success" value="打印订单"/></a>
											</button>
...
<script src="{{ asset('admin/myjs/order/deliver.js') }}"></script>
<script type="text/javascript">
var isCheckAll = false;
 var delUrl="{{ url('admin/order/dels') }}";
  var deltUrl="{{ url('admin/order/delete') }}";
