...
<div class="row">
  <div class="col-xs-12">
    <form class="form-horizontal" role="form" action="{{ url('admin/user/userclass/insert')}}" method="post">
      {{ csrf_field() }}
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 类型名称 </label>
					<div class="col-sm-9">
						<input type="text" id="tname" placeholder="输入分类名称（20字符以内）" maxlength="20"  class="col-xs-10 col-sm-5" name="name" value="" />
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-2" > 开通金额（月）</label>
					<div class="col-sm-9">
						<input type="number" min="0" max="10000" step="0.01" id="pt" placeholder="请输入开通一个月的金额" class="col-xs-10 col-sm-5" name="month_money"/>
            <label class="  col-sm-3 control-label no-padding-right" ></label>
            <div class="col-sm-9 setInfo">
              <p class="spa spa15"></p>
            </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="number" min="0" max="10000" step="0.01" max="1000000" id="py" placeholder="请输入开通一年的金额" class="col-xs-10 col-sm-5" name="year_money"/>
            <label class="  col-sm-3 control-label no-padding-right" ></label>
            <div class="col-sm-9 setInfo">
              <p class="spa spa16"></p>
            </div>
