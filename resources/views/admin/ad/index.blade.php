    ...
    <div class="row">
        <div class="col-xs-12">
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                <td>
                                    <a href="{{url('admin/ad/edit/'.$v["id"])}}">{{$v['title']}}</a>
                                </td>
                                <td>
                                    @if(isset($v['pic']) && !empty($v['pic']))
                                        <img src="{{AD_IMG_PATH.$v['pic']}}" height="80">
                                    @else
                                        <img src="{{ url('admin/images/no.png') }}" height="80">
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="green" href="{{url('admin/ad/edit/'.$v['id'])}}">
    ...
    <script>
        ...
        function delCate(cate_id) {
            layer.confirm('您确定要删除这个广告吗？', {
                ...
                $.post("{{url('admin/ad/del/')}}/" + cate_id, {'_token':"{{csrf_token()}}"}, function (data) {
                    if(data.status==1){
