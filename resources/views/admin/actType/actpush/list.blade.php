...
@section('content')
    ...
    <a href="{{ url('admin/recommend/create') }}">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/recommend/'.$v["id"].'/edit')}}">{{$v['name']}}</a>
                        </td>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="{{url('admin/recommend/'.$v['id'].'/edit')}}">
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        <li>
                                            <a href="{{url('admin/recommend/'.$v['id'].'/edit')}}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
...
@section('js')
    ...
    <script>
        //批量删除地址
        var delUrl="{{ url('admin/recommend/dels') }}";
        var orderUrl="{{ url('admin/recommend') }}";
        ...
        //单个删除地址
        var singleDel="{{url('admin/recommend/')}}/";
        //复制地址
        var copyPro="{{url('admin/recommend/copy')}}/";
    </script>
    {{--产品列表--}}
