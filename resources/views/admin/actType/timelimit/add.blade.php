            ...
            <form class="form-horizontal" role="form" id="addForm"  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-daterange input-group col-sm-9">
                        <input type="text" class="input-sm form-control sjdate" placeholder="开始时间" name="show_time" />
                ...
                <div class="form-group">
                    ...
                    <div class="input-daterange input-group col-sm-9">
                        <input type="text" class="input-sm form-control sjdate" placeholder="结束时间" name="end_time" />
                        <span class="input-group-addon">
                          <i class="fa fa-calendar" aria-hidden="true"></i>
                       </span>
                    </div>
