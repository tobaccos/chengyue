...
@section('content')
    ...
    <a href="{{ url('admin/pre_buy/create') }}">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/pre_buy/'.$v["id"].'/edit')}}">{{$v['name']}}</a>
                        </td>
...
{{--                            {{$v['state']? '禁用': '正常'}}--}}
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="{{url('admin/pre_buy/'.$v['id'].'/edit')}}">
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        <li>
                                            <a href="{{url('admin/pre_buy/'.$v['id'].'/edit')}}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                            <span class="green">
                                                                <i class="ace-icon fa fa-pencil-square-o bigger-120" id="hiddenNO"></i>
                                                            </span>
                                            </a>
                                        </li>
                                        <li>
...
@section('js')
    ...
    <script>
//        批量删除地址
        var delUrl="{{url('admin/pre_buy/dels')}}";
        var orderUrl="{{ url('admin/pre_buy') }}";
        ...
        //单个删除地址
        var singleDel="{{url('admin/pre_buy/')}}/";
        //复制地址
        var copyPro="{{url('admin/pre_buy/copy')}}/";
    </script>
    {{--产品列表--}}
