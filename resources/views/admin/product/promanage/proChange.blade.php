        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" id="addForm"  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="proname" name="name"  placeholder="产品名称" class="col-xs-10 col-sm-5" value="{{$data['name']}}" maxlength="25"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" > 上架时间：</label>
                    <div class="input-daterange input-group col-sm-9">
                        <input type="text" class="input-sm form-control sjdate" placeholder="上架时间" name="show_time" value="{{$data['show_time']}}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" id="prorate" name="rate"  value="{{$data['rate']}}" placeholder="当前产品的默认利率" class="col-xs-10 col-sm-5"  value="0.001"  min="0.001" step="0.001" onchange="var val=parseFloat(this.value).toFixed(3);if(val>=1 |val<=0){val=0.001};this.value=val" />
                    </div>
                </div>
                {{--<div class="form-group">--}}
                    {{--<label class="col-sm-2 control-label no-padding-right" > 温馨提示： </label>--}}
                    {{--<div class="col-sm-9">--}}
                        {{--<textarea  id="proname" name="cue"  required  placeholder="温馨提示" class="col-xs-10 col-sm-5">{{$data['cue']}}</textarea>--}}
                    {{--</div>--}}
                {{--</div>--}}
                <div class="form-group">
...
@section('js')
    ...
    <script>
        ...
        var fd="{{url('admin/product/'.$data['id'])}}";
    </script>
    {{--颜色标志--}}
