            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/product/'.$v["id"].'/edit')}}">{{$v['name']}}</a>
                        </td>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="{{url('admin/product/'.$v['id'].'/edit')}}">
                                ...
                                <a class="blue" href="javascript:;" onclick="copyCate({{$v['id']}})">
                                    <i class="ace-icon fa fa-files-o bigger-130 myicon" aria-hidden="true"></i>
                                </a>
                            </div>
                            {{--缩小的下拉按钮--}}
...
@section('js')
    ...
    <script>
        ...
        var orderUrl="{{url('admin/product')}}";
        ...
        //复制地址
        var copyPro="{{url('admin/product/copy')}}/";
    </script>
    {{--产品列表--}}
