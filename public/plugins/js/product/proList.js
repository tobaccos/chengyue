...
$(".orderItem li").click(function(){
	...
	$.ajax({
		type: "POST",
		url: urlAll,
		data: {type_id:type_id , sortType:sortType , searchWrod:searchWrod,minPrice:minPriceInput,maxPrice:maxPriceInput},
		dataType: "json",
		headers:{
...
$('.searchBtn').click(function(){
    ...
    $.ajax({
        type: "POST",
        url: urlAll,
        data: {searchWrod:searchWrod,type_id:type_id ,minPrice:minPriceInput,maxPrice:maxPriceInput},
        dataType: "json",
        headers:{
            'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
        },
...
$(".checkSure").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: urlAll,
        data: {type_id:type_id,minPrice:minPriceInput,maxPrice:maxPriceInput},
        dataType: "json",
        headers:{
            'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
        },
